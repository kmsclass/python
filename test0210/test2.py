...
photo1 = PhotoImage(file="../20210210/gif/dog4.gif")
photo2 = PhotoImage(file="../20210210/gif/cat.gif")
photo3 = PhotoImage(file="../20210210/gif/rabbit.gif")
