# -*- coding: utf-8 -*-
"""
Created on Thu Feb 18 14:06:56 2021

@author: myung
drinkdataex3.py : 그룹 단위 데이터 분석. 
"""
import pandas as pd
import numpy as np
...
"""
agg 기능 : 
 continent을 기준으로 그룹화.  spirit_servings 데이터 분석.
...
#평균 beer_servings값이 가장 높은 대륙을 조회하기
#idxmax() : 그룹별 평균 중 평균값이 가장 큰값의 index 리턴
bear_continent = drinks.groupby('continent').beer_servings.\
             mean().idxmax()
print(bear_continent)             
...
rects4 = plt.bar\
  (index+bar_width*3,sums,bar_width,color='y',label='Sum')
