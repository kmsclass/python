# -*- coding: utf-8 -*-
"""
Created on Tue Feb 16 10:30:35 2021
...
print(a.ndim)  # 2차원.
print(a.dtype.name) #a 배열의 요소의 자료형이름
print(a.itemsize) #a 배열의 요소의 크기 바이트단위.
print(a.size) # a 배열의 요소의 갯수
print(type(a))
#np.array : 배열을 생성.
b = np.array([6, 7, 8])
print(b)
...
#linspace(s,e,d) : s부터 e까지의 수를 d 등분하기.
