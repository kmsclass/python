# -*- coding: utf-8 -*-
"""
Created on Wed Feb 17 13:33:42 2021

@author: myung

soupex4.py : 네이버 페이지의 환율 정보 조회
"""
...
sel = lambda q : soup.select(q)
 #class 속성이 head_info div태그 들. 환율,상승/하락값,상승/하락
hlist = sel("div.head_info")
#class 속성이 h_lst 인 h3태그 들 . 통화명
htitle = sel("h3.h_lst")  
#zip 함수 설명 
a= [1,2,3,4,5]
b= ["a","b","c","d","e"]
